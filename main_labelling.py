...
df_labelled = labelling.set_labels.get_df_answers_labelled(df_complete, 'TIMES_ONLY_V2_2F')
df_label_statistics = labelling.set_labels.get_df_label_statistics(df_labelled, 'MEDIA_NAME')

df_labelled.to_csv('datasets/results/labels/labelled_dataset_v2_2F.csv', index=False)
df_label_statistics.to_csv('datasets/results/labels/label_statistics_dataset_v2_2F.csv', index=False)
